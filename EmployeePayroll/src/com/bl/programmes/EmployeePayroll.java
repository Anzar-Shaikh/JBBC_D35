...
//    insertIntoDiagram(connection);
    ...
    private static void deleteEmployeeCascade(Connection connection) {
    ...
    private static void checkEmployeeDetails(Connection connection) {
    ...
    private static void insertIntoDiagram(Connection connection) {
    ...
    private static void addNewEmployees(Connection connection) {
